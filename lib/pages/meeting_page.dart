...
import 'package:webrtc/pages/home_screen.dart';
import 'package:webrtc/utils/user.utils.dart';
import 'package:webrtc/widgets/control_panel.dart';
import 'package:webrtc/widgets/remote_connection.dart';
...
class _MeetingPageState extends State<MeetingPage> {
  ...
  _buildMeetingRoom() {
    return Stack(
      children: [
        ...
        Positioned(bottom:  10.0,right: 0,child: SizedBox(
          width: 150.0,
          height: 200.0,
 ...
 bool isAudioEnabled() {
  ...
  void goToHomePage() {
    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=> const HomeScreenState()));
  }
}
